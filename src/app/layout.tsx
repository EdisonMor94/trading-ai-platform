...
export const metadata: Metadata = {
  ...
  description: "Valida tus análisis de trading con IA",
};
      ...
      <body className={inter.className}>
        <div className="flex min-h-screen bg-gray-900 text-white">
          ...
          <aside className="w-64 bg-gray-800 p-6 border-r border-gray-700">
            <h1 className="text-2xl font-bold mb-8">TradeAI</h1>
            <nav className="space-y-4">
              <a href="/dashboard" className="bg-gray-700 text-white flex items-center p-3 rounded-lg">
                {/* Ícono SVG simple de un gráfico */}
              ...
              <a href="#" className="flex items-center p-3 rounded-lg hover:bg-gray-700">
                {/* Ícono SVG simple de un historial */}
              ...
              <a href="#" className="flex items-center p-3 rounded-lg hover:bg-gray-700">
                {/* Ícono SVG simple de configuración */}
